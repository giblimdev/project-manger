...
INSERT INTO "new_comments" ("authorId", "content", "createdAt", "featureId", "id", "parentCommentId", "roadMapId", "sprintId", "taskId", "thema", "title", "updatedAt", "userStoryId") SELECT "authorId", "content", "createdAt", "featureId", "id", "parentCommentId", "roadMapId", "sprintId", "taskId", "thema", "title", "updatedAt", "userStoryId" FROM "comments";
DROP TABLE "comments";
